        ...
        <section class="profile">
            ...
            <nav class="nav-menu">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('topics.listAllTopics') }}"><i class="bi bi-chat"></i> Tópicos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('listAllTags') }}"><i class="bi bi-tags"></i> Tags</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('listAllCategories') }}"><i class="bi bi-list"></i> Categorias</a>
                    </li>
                </ul>
            </nav>
        </section>
